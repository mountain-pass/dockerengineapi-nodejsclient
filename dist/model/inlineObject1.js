  ...
  _createClass(InlineObject1, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('Detach')) {
          obj['Detach'] = _ApiClient["default"].convertToType(data['Detach'], 'Boolean');
        }
 ...
 * @member {Boolean} Detach
 */


InlineObject1.prototype['Detach'] = undefined;
/**
 * Allocate a pseudo-TTY.
 * @member {Boolean} Tty
 */

InlineObject1.prototype['Tty'] = undefined;
