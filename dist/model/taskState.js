...
var TaskState = /*#__PURE__*/function () {
  function TaskState() {
    ...
    _defineProperty(this, "allocated", "allocated");

    _defineProperty(this, "pending", "pending");

    _defineProperty(this, "assigned", "assigned");
    ...
    _defineProperty(this, "shutdown", "shutdown");
    ...
    _defineProperty(this, "orphaned", "orphaned");
  }

  _createClass(TaskState, null, [{
