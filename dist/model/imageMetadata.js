...
var ImageMetadata = /*#__PURE__*/function () {
  ...
  _createClass(ImageMetadata, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('LastTagTime')) {
          obj['LastTagTime'] = _ApiClient["default"].convertToType(data['LastTagTime'], 'String');
        }
      }
...
/**
 * @member {String} LastTagTime
 */


ImageMetadata.prototype['LastTagTime'] = undefined;
var _default = ImageMetadata;
