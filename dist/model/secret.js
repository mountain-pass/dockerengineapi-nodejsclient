...
var _SecretSpec = _interopRequireDefault(require("./SecretSpec"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('Spec')) {
          obj['Spec'] = _SecretSpec["default"].constructFromObject(data['Spec']);
        }
      }
...
Secret.prototype['Version'] = undefined;
/**
 * @member {String} CreatedAt
 */

Secret.prototype['CreatedAt'] = undefined;
/**
 * @member {String} UpdatedAt
 */

Secret.prototype['UpdatedAt'] = undefined;
/**
 * @member {module:model/SecretSpec} Spec
 */

Secret.prototype['Spec'] = undefined;
var _default = Secret;
