...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/Task'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/Task'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.TaskApi = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ErrorResponse, root.DockerEngineApi.Task);
  }
}(this, function(ApiClient, ErrorResponse, Task) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.taskInspect = function(id, callback) {
      var postBody = null;
     ...
     */
    this.taskList = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.taskLogs = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;
