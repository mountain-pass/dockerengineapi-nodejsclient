...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DistributionInspectResponse', 'model/ErrorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DistributionInspectResponse'), require('../model/ErrorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.DistributionApi = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.DistributionInspectResponse, root.DockerEngineApi.ErrorResponse);
  }
}(this, function(ApiClient, DistributionInspectResponse, ErrorResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.distributionInspect = function(name, callback) {
      var postBody = null;
      ...
      var returnType = DistributionInspectResponse;
