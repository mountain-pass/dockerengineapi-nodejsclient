...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TaskState', 'model/TaskStatusContainerStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TaskState'), require('./TaskStatusContainerStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.TaskStatus = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.TaskState, root.DockerEngineApi.TaskStatusContainerStatus);
  }
}(this, function(ApiClient, TaskState, TaskStatusContainerStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ContainerStatus'))
        obj.containerStatus = TaskStatusContainerStatus.constructFromObject(data['ContainerStatus']);
    }
    return obj;
  }
   ...
   */
  exports.prototype.containerStatus = undefined;
