...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.BuildCache = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('LastUsedAt'))
        obj.lastUsedAt = ApiClient.convertToType(data['LastUsedAt'], 'String');
   ...
   */
  exports.prototype.inUse = undefined;
