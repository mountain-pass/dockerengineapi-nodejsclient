...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClusterInfo', 'model/LocalNodeState', 'model/PeerNode'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ClusterInfo'), require('./LocalNodeState'), require('./PeerNode'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.SwarmInfo = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ClusterInfo, root.DockerEngineApi.LocalNodeState, root.DockerEngineApi.PeerNode);
  }
}(this, function(ApiClient, ClusterInfo, LocalNodeState, PeerNode) {
  'use strict';
   ...
   * @default ''
   */
  exports.prototype.nodeAddr = '';

  /**
   * @member {module:model/LocalNodeState} localNodeState
   */
  exports.prototype.localNodeState = undefined;

  /**
   * @member {Boolean} controlAvailable
   * @default false
   */
  exports.prototype.controlAvailable = false;

  /**
   * @member {String} error
   * @default ''
   */
  exports.prototype.error = '';

  /**
   * List of ID's and addresses of other managers in the swarm. 
   * @member {Array.<module:model/PeerNode>} remoteManagers
   */
  exports.prototype.remoteManagers = undefined;
