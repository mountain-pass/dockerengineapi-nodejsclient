...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.DistributionInspectResponsePlatforms = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('OSFeatures'))
        obj.oSFeatures = ApiClient.convertToType(data['OSFeatures'], ['String']);
