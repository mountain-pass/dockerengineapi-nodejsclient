...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.TLSInfo = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('TrustRoot'))
        obj.trustRoot = ApiClient.convertToType(data['TrustRoot'], 'String');
      if (data.hasOwnProperty('CertIssuerSubject'))
        obj.certIssuerSubject = ApiClient.convertToType(data['CertIssuerSubject'], 'String');
      if (data.hasOwnProperty('CertIssuerPublicKey'))
        obj.certIssuerPublicKey = ApiClient.convertToType(data['CertIssuerPublicKey'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.trustRoot = undefined;

  /**
   * The base64-url-safe-encoded raw subject bytes of the issuer.
   * @member {String} certIssuerSubject
   */
  exports.prototype.certIssuerSubject = undefined;

  /**
   * The base64-url-safe-encoded raw public key bytes of the issuer. 
   * @member {String} certIssuerPublicKey
   */
  exports.prototype.certIssuerPublicKey = undefined;
