...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SystemEventsResponseActor'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SystemEventsResponseActor'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.SystemEventsResponse = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.SystemEventsResponseActor);
  }
}(this, function(ApiClient, SystemEventsResponseActor) {
  'use strict';
   ...
   */
  exports.prototype.timeNano = undefined;
