...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.SwarmSpecDispatcher = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('HeartbeatPeriod'))
        obj.heartbeatPeriod = ApiClient.convertToType(data['HeartbeatPeriod'], 'Number');
    }
    return obj;
  }
   ...
   */
  exports.prototype.heartbeatPeriod = undefined;
