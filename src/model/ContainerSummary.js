...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContainerSummaryInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContainerSummaryInner'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ContainerSummary = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ContainerSummaryInner);
  }
}(this, function(ApiClient, ContainerSummaryInner) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'ContainerSummaryInner');
    }
    return obj;
  }
