...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.TaskSpecPluginSpec = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.Body);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PluginPrivilege'))
        obj.pluginPrivilege = ApiClient.convertToType(data['PluginPrivilege'], [Body]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Body>} pluginPrivilege
   */
  exports.prototype.pluginPrivilege = undefined;
