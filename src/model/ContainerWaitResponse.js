...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContainerWaitResponseError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContainerWaitResponseError'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ContainerWaitResponse = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ContainerWaitResponseError);
  }
}(this, function(ApiClient, ContainerWaitResponseError) {
  'use strict';
   ...
   */
  var exports = function(statusCode) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Error'))
        obj.error = ContainerWaitResponseError.constructFromObject(data['Error']);
    }
    return obj;
  }
