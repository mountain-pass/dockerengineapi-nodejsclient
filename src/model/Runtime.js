...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.Runtime = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('runtimeArgs'))
        obj.runtimeArgs = ApiClient.convertToType(data['runtimeArgs'], ['String']);
    }
    return obj;
  }
   ...
   */
  exports.prototype.runtimeArgs = undefined;
