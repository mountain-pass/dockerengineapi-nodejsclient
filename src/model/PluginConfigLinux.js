...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PluginDevice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PluginDevice'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.PluginConfigLinux = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.PluginDevice);
  }
}(this, function(ApiClient, PluginDevice) {
  'use strict';
   ...
   */
  var exports = function(capabilities, allowAllDevices, devices) {
   ...
   */
  exports.prototype.allowAllDevices = undefined;
