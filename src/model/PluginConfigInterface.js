...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PluginInterfaceType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PluginInterfaceType'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.PluginConfigInterface = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.PluginInterfaceType);
  }
}(this, function(ApiClient, PluginInterfaceType) {
  'use strict';
   ...
   * @param socket {String} 
   */
  var exports = function(types, socket) {
    this.types = types;
    this.socket = socket;
  };
