...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.TaskSpecPlacementSpread = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('SpreadDescriptor'))
        obj.spreadDescriptor = ApiClient.convertToType(data['SpreadDescriptor'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.spreadDescriptor = undefined;
