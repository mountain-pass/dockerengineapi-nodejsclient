...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorDetail', 'model/ImageID', 'model/ProgressDetail'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ErrorDetail'), require('./ImageID'), require('./ProgressDetail'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.BuildInfo = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ErrorDetail, root.DockerEngineApi.ImageID, root.DockerEngineApi.ProgressDetail);
  }
}(this, function(ApiClient, ErrorDetail, ImageID, ProgressDetail) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('progressDetail'))
        obj.progressDetail = ProgressDetail.constructFromObject(data['progressDetail']);
      if (data.hasOwnProperty('aux'))
        obj.aux = ImageID.constructFromObject(data['aux']);
    }
    return obj;
  }
   ...
   */
  exports.prototype.progressDetail = undefined;

  /**
   * @member {module:model/ImageID} aux
   */
  exports.prototype.aux = undefined;
