...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectVersion', 'model/SecretSpec'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectVersion'), require('./SecretSpec'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.Secret = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ObjectVersion, root.DockerEngineApi.SecretSpec);
  }
}(this, function(ApiClient, ObjectVersion, SecretSpec) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Spec'))
        obj.spec = SecretSpec.constructFromObject(data['Spec']);
    }
    return obj;
  }
