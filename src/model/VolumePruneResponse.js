...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.VolumePruneResponse = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('VolumesDeleted'))
        obj.volumesDeleted = ApiClient.convertToType(data['VolumesDeleted'], ['String']);
   ...
   */
  exports.prototype.volumesDeleted = undefined;
