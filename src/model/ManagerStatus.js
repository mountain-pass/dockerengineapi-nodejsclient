...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Reachability'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Reachability'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ManagerStatus = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.Reachability);
  }
}(this, function(ApiClient, Reachability) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Reachability'))
        obj.reachability = Reachability.constructFromObject(data['Reachability']);
   ...
   * @default false
   */
  exports.prototype.leader = false;

  /**
   * @member {module:model/Reachability} reachability
   */
  exports.prototype.reachability = undefined;
