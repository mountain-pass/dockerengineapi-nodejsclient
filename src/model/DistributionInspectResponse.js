...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DistributionInspectResponseDescriptor', 'model/DistributionInspectResponsePlatforms'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DistributionInspectResponseDescriptor'), require('./DistributionInspectResponsePlatforms'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.DistributionInspectResponse = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.DistributionInspectResponseDescriptor, root.DockerEngineApi.DistributionInspectResponsePlatforms);
  }
}(this, function(ApiClient, DistributionInspectResponseDescriptor, DistributionInspectResponsePlatforms) {
  'use strict';
   ...
   */
  var exports = function(descriptor, platforms) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Descriptor'))
        obj.descriptor = DistributionInspectResponseDescriptor.constructFromObject(data['Descriptor']);
      if (data.hasOwnProperty('Platforms'))
        obj.platforms = ApiClient.convertToType(data['Platforms'], [DistributionInspectResponsePlatforms]);
    }
    return obj;
  }
