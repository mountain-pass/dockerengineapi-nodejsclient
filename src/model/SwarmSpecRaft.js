...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.SwarmSpecRaft = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('SnapshotInterval'))
        obj.snapshotInterval = ApiClient.convertToType(data['SnapshotInterval'], 'Number');
      if (data.hasOwnProperty('KeepOldSnapshots'))
        obj.keepOldSnapshots = ApiClient.convertToType(data['KeepOldSnapshots'], 'Number');
      if (data.hasOwnProperty('LogEntriesForSlowFollowers'))
        obj.logEntriesForSlowFollowers = ApiClient.convertToType(data['LogEntriesForSlowFollowers'], 'Number');
      if (data.hasOwnProperty('ElectionTick'))
        obj.electionTick = ApiClient.convertToType(data['ElectionTick'], 'Number');
      if (data.hasOwnProperty('HeartbeatTick'))
        obj.heartbeatTick = ApiClient.convertToType(data['HeartbeatTick'], 'Number');
    }
    return obj;
  }
   ...
   */
  exports.prototype.keepOldSnapshots = undefined;

  /**
   * The number of log entries to keep around to sync up slow followers after a snapshot is created. 
   * @member {Number} logEntriesForSlowFollowers
   */
  exports.prototype.logEntriesForSlowFollowers = undefined;
   ...
   */
  exports.prototype.electionTick = undefined;
   ...
   */
  exports.prototype.heartbeatTick = undefined;
