...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.ImageSearchResponseItem = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_official'))
        obj.isOfficial = ApiClient.convertToType(data['is_official'], 'Boolean');
      if (data.hasOwnProperty('is_automated'))
        obj.isAutomated = ApiClient.convertToType(data['is_automated'], 'Boolean');
  ...
  /**
   * @member {Boolean} isOfficial
   */
  exports.prototype.isOfficial = undefined;

  /**
   * @member {Boolean} isAutomated
   */
  exports.prototype.isAutomated = undefined;
