...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.SwarmSpecOrchestration = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('TaskHistoryRetentionLimit'))
        obj.taskHistoryRetentionLimit = ApiClient.convertToType(data['TaskHistoryRetentionLimit'], 'Number');
    }
    return obj;
  }
   ...
   */
  exports.prototype.taskHistoryRetentionLimit = undefined;
