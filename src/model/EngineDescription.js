...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EngineDescriptionPlugins'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EngineDescriptionPlugins'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.EngineDescription = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.EngineDescriptionPlugins);
  }
}(this, function(ApiClient, EngineDescriptionPlugins) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Plugins'))
        obj.plugins = ApiClient.convertToType(data['Plugins'], [EngineDescriptionPlugins]);
    }
    return obj;
  }
