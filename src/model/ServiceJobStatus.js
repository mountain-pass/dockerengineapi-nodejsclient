...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectVersion'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectVersion'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ServiceJobStatus = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ObjectVersion);
  }
}(this, function(ApiClient, ObjectVersion) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('LastExecution'))
        obj.lastExecution = ApiClient.convertToType(data['LastExecution'], 'String');
    }
    return obj;
  }
