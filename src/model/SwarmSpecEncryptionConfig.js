...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.SwarmSpecEncryptionConfig = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('AutoLockManagers'))
        obj.autoLockManagers = ApiClient.convertToType(data['AutoLockManagers'], 'Boolean');
    }
    return obj;
  }
   ...
   */
  exports.prototype.autoLockManagers = undefined;
