...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.Address = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PrefixLen'))
        obj.prefixLen = ApiClient.convertToType(data['PrefixLen'], 'Number');
    }
    return obj;
  }
   ...
   */
  exports.prototype.prefixLen = undefined;
