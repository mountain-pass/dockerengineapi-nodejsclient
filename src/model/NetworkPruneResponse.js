...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.NetworkPruneResponse = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('NetworksDeleted'))
        obj.networksDeleted = ApiClient.convertToType(data['NetworksDeleted'], ['String']);
    }
    return obj;
  }
   ...
   */
  exports.prototype.networksDeleted = undefined;
