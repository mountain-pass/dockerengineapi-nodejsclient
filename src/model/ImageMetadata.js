...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.ImageMetadata = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('LastTagTime'))
        obj.lastTagTime = ApiClient.convertToType(data['LastTagTime'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.lastTagTime = undefined;
