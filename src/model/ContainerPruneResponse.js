...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.ContainerPruneResponse = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ContainersDeleted'))
        obj.containersDeleted = ApiClient.convertToType(data['ContainersDeleted'], ['String']);
   ...
   */
  exports.prototype.containersDeleted = undefined;
