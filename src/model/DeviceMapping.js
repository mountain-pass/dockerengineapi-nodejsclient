...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.DeviceMapping = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PathOnHost'))
        obj.pathOnHost = ApiClient.convertToType(data['PathOnHost'], 'String');
      if (data.hasOwnProperty('PathInContainer'))
        obj.pathInContainer = ApiClient.convertToType(data['PathInContainer'], 'String');
      if (data.hasOwnProperty('CgroupPermissions'))
        obj.cgroupPermissions = ApiClient.convertToType(data['CgroupPermissions'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.pathOnHost = undefined;

  /**
   * @member {String} pathInContainer
   */
  exports.prototype.pathInContainer = undefined;

  /**
   * @member {String} cgroupPermissions
   */
  exports.prototype.cgroupPermissions = undefined;
