...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConfigSpec', 'model/ObjectVersion'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConfigSpec'), require('./ObjectVersion'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.Config = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ConfigSpec, root.DockerEngineApi.ObjectVersion);
  }
}(this, function(ApiClient, ConfigSpec, ObjectVersion) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Spec'))
        obj.spec = ConfigSpec.constructFromObject(data['Spec']);
    }
    return obj;
  }
