...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.NetworkingConfig = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.EndpointSettings);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('EndpointsConfig'))
        obj.endpointsConfig = ApiClient.convertToType(data['EndpointsConfig'], {'String': EndpointSettings});
    }
    return obj;
  }
   ...
   */
  exports.prototype.endpointsConfig = undefined;
