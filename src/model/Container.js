...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.Container = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.EndpointSettings);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('EndpointConfig'))
        obj.endpointConfig = EndpointSettings.constructFromObject(data['EndpointConfig']);
    }
    return obj;
  }
   ...
   */
  exports.prototype.endpointConfig = undefined;
