...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SwarmSpecTaskDefaultsLogDriver'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SwarmSpecTaskDefaultsLogDriver'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.SwarmSpecTaskDefaults = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.SwarmSpecTaskDefaultsLogDriver);
  }
}(this, function(ApiClient, SwarmSpecTaskDefaultsLogDriver) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('LogDriver'))
        obj.logDriver = SwarmSpecTaskDefaultsLogDriver.constructFromObject(data['LogDriver']);
    }
    return obj;
  }
