...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EngineDescription', 'model/Platform', 'model/ResourceObject', 'model/TLSInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EngineDescription'), require('./Platform'), require('./ResourceObject'), require('./TLSInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.NodeDescription = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.EngineDescription, root.DockerEngineApi.Platform, root.DockerEngineApi.ResourceObject, root.DockerEngineApi.TLSInfo);
  }
}(this, function(ApiClient, EngineDescription, Platform, ResourceObject, TLSInfo) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Resources'))
        obj.resources = ResourceObject.constructFromObject(data['Resources']);
      if (data.hasOwnProperty('Engine'))
        obj.engine = EngineDescription.constructFromObject(data['Engine']);
   ...
   */
  exports.prototype.tLSInfo = undefined;
