...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.SwarmSpecCAConfigExternalCAs = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('CACert'))
        obj.cACert = ApiClient.convertToType(data['CACert'], 'String');
    }
    return obj;
  }
   ...
   * @default 'cfssl'
   */
  exports.prototype.protocol = 'cfssl';
   ...
   */
  exports.prototype.cACert = undefined;
