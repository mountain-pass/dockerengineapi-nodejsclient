...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TaskSpecContainerSpecFile1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TaskSpecContainerSpecFile1'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.TaskSpecContainerSpecConfigs = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.TaskSpecContainerSpecFile1);
  }
}(this, function(ApiClient, TaskSpecContainerSpecFile1) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('File'))
        obj.file = TaskSpecContainerSpecFile1.constructFromObject(data['File']);
      if (data.hasOwnProperty('Runtime'))
        obj.runtime = ApiClient.convertToType(data['Runtime'], Object);
