...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectVersion', 'model/SwarmSpec', 'model/TLSInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectVersion'), require('./SwarmSpec'), require('./TLSInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ClusterInfo = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.ObjectVersion, root.DockerEngineApi.SwarmSpec, root.DockerEngineApi.TLSInfo);
  }
}(this, function(ApiClient, ObjectVersion, SwarmSpec, TLSInfo) {
  'use strict';
   ...
   */
  exports.prototype.rootRotationInProgress = undefined;
