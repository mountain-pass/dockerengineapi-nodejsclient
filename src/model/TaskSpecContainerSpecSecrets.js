...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TaskSpecContainerSpecFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TaskSpecContainerSpecFile'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.TaskSpecContainerSpecSecrets = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.TaskSpecContainerSpecFile);
  }
}(this, function(ApiClient, TaskSpecContainerSpecFile) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('File'))
        obj.file = TaskSpecContainerSpecFile.constructFromObject(data['File']);
   ...
   */
  exports.prototype.secretID = undefined;
