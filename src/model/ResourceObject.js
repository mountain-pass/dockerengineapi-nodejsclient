...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GenericResources'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GenericResources'));
  } else {
    // Browser globals (root is window)
    if (!root.DockerEngineApi) {
      root.DockerEngineApi = {};
    }
    root.DockerEngineApi.ResourceObject = factory(root.DockerEngineApi.ApiClient, root.DockerEngineApi.GenericResources);
  }
}(this, function(ApiClient, GenericResources) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('MemoryBytes'))
        obj.memoryBytes = ApiClient.convertToType(data['MemoryBytes'], 'Number');
   ...
   */
  exports.prototype.memoryBytes = undefined;
