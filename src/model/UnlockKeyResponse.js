...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerEngineApi.UnlockKeyResponse = factory(root.DockerEngineApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('UnlockKey'))
        obj.unlockKey = ApiClient.convertToType(data['UnlockKey'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.unlockKey = undefined;
