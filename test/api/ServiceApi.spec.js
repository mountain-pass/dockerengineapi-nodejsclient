  ...
  describe('ServiceApi', function() {
    describe('serviceCreate', function() {
      it('should call serviceCreate successfully', function(done) {
        //uncomment below and update the code to test serviceCreate
        //instance.serviceCreate(function(error) {
    ...
    describe('serviceInspect', function() {
      it('should call serviceInspect successfully', function(done) {
        //uncomment below and update the code to test serviceInspect
        //instance.serviceInspect(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serviceLogs', function() {
      it('should call serviceLogs successfully', function(done) {
        //uncomment below and update the code to test serviceLogs
        //instance.serviceLogs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serviceUpdate', function() {
      it('should call serviceUpdate successfully', function(done) {
        //uncomment below and update the code to test serviceUpdate
        //instance.serviceUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
