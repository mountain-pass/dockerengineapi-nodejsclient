  ...
  describe('VolumeApi', function() {
    ...
    describe('volumeInspect', function() {
      it('should call volumeInspect successfully', function(done) {
        //uncomment below and update the code to test volumeInspect
        //instance.volumeInspect(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumePrune', function() {
      it('should call volumePrune successfully', function(done) {
        //uncomment below and update the code to test volumePrune
        //instance.volumePrune(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
