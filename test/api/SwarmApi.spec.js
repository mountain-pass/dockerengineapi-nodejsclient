  ...
  describe('SwarmApi', function() {
    describe('swarmInit', function() {
      it('should call swarmInit successfully', function(done) {
        //uncomment below and update the code to test swarmInit
        //instance.swarmInit(function(error) {
    ...
    describe('swarmInspect', function() {
      it('should call swarmInspect successfully', function(done) {
        //uncomment below and update the code to test swarmInspect
        //instance.swarmInspect(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('swarmJoin', function() {
      it('should call swarmJoin successfully', function(done) {
        //uncomment below and update the code to test swarmJoin
        //instance.swarmJoin(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('swarmLeave', function() {
      it('should call swarmLeave successfully', function(done) {
        //uncomment below and update the code to test swarmLeave
        //instance.swarmLeave(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('swarmUnlock', function() {
      it('should call swarmUnlock successfully', function(done) {
        //uncomment below and update the code to test swarmUnlock
        //instance.swarmUnlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('swarmUnlockkey', function() {
      it('should call swarmUnlockkey successfully', function(done) {
        //uncomment below and update the code to test swarmUnlockkey
        //instance.swarmUnlockkey(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('swarmUpdate', function() {
      it('should call swarmUpdate successfully', function(done) {
        //uncomment below and update the code to test swarmUpdate
        //instance.swarmUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
