  ...
  describe('TaskApi', function() {
    describe('taskInspect', function() {
      it('should call taskInspect successfully', function(done) {
        //uncomment below and update the code to test taskInspect
        //instance.taskInspect(function(error) {
    ...
    describe('taskLogs', function() {
      it('should call taskLogs successfully', function(done) {
        //uncomment below and update the code to test taskLogs
        //instance.taskLogs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
