...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.PluginSettings();
  });
  ...
  describe('PluginSettings', function() {
    it('should create an instance of PluginSettings', function() {
      ...
      //var instane = new DockerEngineApi.PluginSettings();
      //expect(instance).to.be.a(DockerEngineApi.PluginSettings);
    });
    ...
    it('should have the property mounts (base name: "Mounts")', function() {
      ...
      //var instance = new DockerEngineApi.PluginSettings();
