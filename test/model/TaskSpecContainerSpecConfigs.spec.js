...
(function(root, factory) {
  ...
  describe('TaskSpecContainerSpecConfigs', function() {
    it('should create an instance of TaskSpecContainerSpecConfigs', function() {
      // uncomment below and update the code to test TaskSpecContainerSpecConfigs
      //var instane = new DockerEngineApi.TaskSpecContainerSpecConfigs();
      //expect(instance).to.be.a(DockerEngineApi.TaskSpecContainerSpecConfigs);
    });

    it('should have the property file (base name: "File")', function() {
      // uncomment below and update the code to test the property file
      //var instance = new DockerEngineApi.TaskSpecContainerSpecConfigs();
