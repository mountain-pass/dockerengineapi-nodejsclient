...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new DockerEngineApi.InlineObject3();
      //expect(instance).to.be.a(DockerEngineApi.InlineObject3);
    });
    ...
    it('should have the property container (base name: "Container")', function() {
      ...
      //var instance = new DockerEngineApi.InlineObject3();
