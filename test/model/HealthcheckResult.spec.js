...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.HealthcheckResult();
  });
  ...
  describe('HealthcheckResult', function() {
    it('should create an instance of HealthcheckResult', function() {
      ...
      //var instane = new DockerEngineApi.HealthcheckResult();
      //expect(instance).to.be.a(DockerEngineApi.HealthcheckResult);
    });

    it('should have the property start (base name: "Start")', function() {
      // uncomment below and update the code to test the property start
      //var instance = new DockerEngineApi.HealthcheckResult();
