...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkContainer', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.NetworkContainer();
      });

      it('should create an instance of NetworkContainer', function() {
        // TODO: update the code to test NetworkContainer
        expect(instance).to.be.a(DockerEngineApi.NetworkContainer);
      });
