...
(function(root, factory) {
  ...
  describe('NetworkContainer', function() {
    it('should create an instance of NetworkContainer', function() {
      // uncomment below and update the code to test NetworkContainer
      //var instane = new DockerEngineApi.NetworkContainer();
      //expect(instance).to.be.a(DockerEngineApi.NetworkContainer);
    });

    it('should have the property name (base name: "Name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new DockerEngineApi.NetworkContainer();
