...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PluginConfigLinux', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.PluginConfigLinux();
      });

      it('should create an instance of PluginConfigLinux', function() {
        // TODO: update the code to test PluginConfigLinux
        expect(instance).to.be.a(DockerEngineApi.PluginConfigLinux);
      });
      ...
      it('should have the property allowAllDevices (base name: "AllowAllDevices")', function() {
        // TODO: update the code to test the property allowAllDevices
        expect(instance).to.have.property('allowAllDevices');
        // expect(instance.allowAllDevices).to.be(expectedValueLiteral);
      });
