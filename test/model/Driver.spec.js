...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.Driver();
  });
  ...
  describe('Driver', function() {
    it('should create an instance of Driver', function() {
      ...
      //var instane = new DockerEngineApi.Driver();
      //expect(instance).to.be.a(DockerEngineApi.Driver);
    });

    it('should have the property name (base name: "Name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new DockerEngineApi.Driver();
