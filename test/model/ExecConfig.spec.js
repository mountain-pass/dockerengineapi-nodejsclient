...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecConfig', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.ExecConfig();
      });

      it('should create an instance of ExecConfig', function() {
        // TODO: update the code to test ExecConfig
        expect(instance).to.be.a(DockerEngineApi.ExecConfig);
      });
