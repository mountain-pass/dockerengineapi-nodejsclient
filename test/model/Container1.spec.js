...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Container1', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.Container1();
      });

      it('should create an instance of Container1', function() {
        // TODO: update the code to test Container1
        expect(instance).to.be.a(DockerEngineApi.Container1);
      });
