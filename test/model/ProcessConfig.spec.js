...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.ProcessConfig();
  });
  ...
  describe('ProcessConfig', function() {
    it('should create an instance of ProcessConfig', function() {
      // uncomment below and update the code to test ProcessConfig
      //var instane = new DockerEngineApi.ProcessConfig();
      //expect(instance).to.be.a(DockerEngineApi.ProcessConfig);
    });
    ...
    it('should have the property privileged (base name: "privileged")', function() {
      ...
      //var instance = new DockerEngineApi.ProcessConfig();
