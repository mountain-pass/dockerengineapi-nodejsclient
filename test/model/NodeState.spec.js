...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeState', function() {
      beforeEach(function() {
        instance = DockerEngineApi.NodeState;
      });

      it('should create an instance of NodeState', function() {
        // TODO: update the code to test NodeState
      ...
      it('should have the property down', function() {
        expect(instance).to.have.property('down');
        expect(instance.down).to.be("down");
      });
      ...
      it('should have the property disconnected', function() {
        expect(instance).to.have.property('disconnected');
        expect(instance.disconnected).to.be("disconnected");
      });
