...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkConfig', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.NetworkConfig();
      });

      it('should create an instance of NetworkConfig', function() {
        // TODO: update the code to test NetworkConfig
        expect(instance).to.be.a(DockerEngineApi.NetworkConfig);
      });
      ...
      it('should have the property checkDuplicate (base name: "CheckDuplicate")', function() {
        // TODO: update the code to test the property checkDuplicate
        expect(instance).to.have.property('checkDuplicate');
        // expect(instance.checkDuplicate).to.be(expectedValueLiteral);
      });
