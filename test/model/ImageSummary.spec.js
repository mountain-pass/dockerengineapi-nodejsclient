...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ImageSummary', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.ImageSummary();
      });

      it('should create an instance of ImageSummary', function() {
        // TODO: update the code to test ImageSummary
        expect(instance).to.be.a(DockerEngineApi.ImageSummary);
      });
      ...
      it('should have the property sharedSize (base name: "SharedSize")', function() {
        // TODO: update the code to test the property sharedSize
        expect(instance).to.have.property('sharedSize');
        // expect(instance.sharedSize).to.be(expectedValueLiteral);
      });
