...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceEndpoint', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.ServiceEndpoint();
      });

      it('should create an instance of ServiceEndpoint', function() {
        // TODO: update the code to test ServiceEndpoint
        expect(instance).to.be.a(DockerEngineApi.ServiceEndpoint);
      });
      ...
      it('should have the property virtualIPs (base name: "VirtualIPs")', function() {
        // TODO: update the code to test the property virtualIPs
        expect(instance).to.have.property('virtualIPs');
        // expect(instance.virtualIPs).to.be(expectedValueLiteral);
      });
