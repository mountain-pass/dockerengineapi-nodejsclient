...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.Platform();
  });
  ...
  describe('Platform', function() {
    it('should create an instance of Platform', function() {
      ...
      //var instane = new DockerEngineApi.Platform();
      //expect(instance).to.be.a(DockerEngineApi.Platform);
    });
    ...
    it('should have the property architecture (base name: "Architecture")', function() {
      ...
      //var instance = new DockerEngineApi.Platform();
