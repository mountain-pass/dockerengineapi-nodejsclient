  ...
  describe('(package)', function() {
    describe('SystemEventsResponse', function() {
      ...
      it('should create an instance of SystemEventsResponse', function() {
        // TODO: update the code to test SystemEventsResponse
      ...
      it('should have the property timeNano (base name: "timeNano")', function() {
        // TODO: update the code to test the property timeNano
        expect(instance).to.have.property('timeNano');
        // expect(instance.timeNano).to.be(expectedValueLiteral);
      });
