...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EngineDescription', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.EngineDescription();
      });

      it('should create an instance of EngineDescription', function() {
        // TODO: update the code to test EngineDescription
        expect(instance).to.be.a(DockerEngineApi.EngineDescription);
      });

      it('should have the property engineVersion (base name: "EngineVersion")', function() {
        // TODO: update the code to test the property engineVersion
        expect(instance).to.have.property('engineVersion');
        // expect(instance.engineVersion).to.be(expectedValueLiteral);
      });
