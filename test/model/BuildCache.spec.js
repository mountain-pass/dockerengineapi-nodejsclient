...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BuildCache', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.BuildCache();
      });

      it('should create an instance of BuildCache', function() {
        // TODO: update the code to test BuildCache
        expect(instance).to.be.a(DockerEngineApi.BuildCache);
      });
      ...
      it('should have the property inUse (base name: "InUse")', function() {
        // TODO: update the code to test the property inUse
        expect(instance).to.have.property('inUse');
        // expect(instance.inUse).to.be(expectedValueLiteral);
      });
