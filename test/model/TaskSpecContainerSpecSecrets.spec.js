...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskSpecContainerSpecSecrets', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.TaskSpecContainerSpecSecrets();
      });

      it('should create an instance of TaskSpecContainerSpecSecrets', function() {
        // TODO: update the code to test TaskSpecContainerSpecSecrets
        expect(instance).to.be.a(DockerEngineApi.TaskSpecContainerSpecSecrets);
      });
      ...
      it('should have the property secretName (base name: "SecretName")', function() {
        // TODO: update the code to test the property secretName
        expect(instance).to.have.property('secretName');
        // expect(instance.secretName).to.be(expectedValueLiteral);
      });
