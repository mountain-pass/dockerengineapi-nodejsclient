...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse400', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.InlineResponse400();
      });

      it('should create an instance of InlineResponse400', function() {
        // TODO: update the code to test InlineResponse400
        expect(instance).to.be.a(DockerEngineApi.InlineResponse400);
      });

      it('should have the property errorResponse (base name: "ErrorResponse")', function() {
        // TODO: update the code to test the property errorResponse
        expect(instance).to.have.property('errorResponse');
        // expect(instance.errorResponse).to.be(expectedValueLiteral);
      });
