...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.Config();
  });
  ...
  describe('Config', function() {
    it('should create an instance of Config', function() {
      ...
      //var instane = new DockerEngineApi.Config();
      //expect(instance).to.be.a(DockerEngineApi.Config);
    });

    it('should have the property ID (base name: "ID")', function() {
      // uncomment below and update the code to test the property ID
      //var instance = new DockerEngineApi.Config();
