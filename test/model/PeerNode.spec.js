...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.PeerNode();
  });
  ...
  describe('PeerNode', function() {
    it('should create an instance of PeerNode', function() {
      // uncomment below and update the code to test PeerNode
      //var instane = new DockerEngineApi.PeerNode();
      //expect(instance).to.be.a(DockerEngineApi.PeerNode);
    });
    ...
    it('should have the property nodeID (base name: "NodeID")', function() {
      ...
      //var instance = new DockerEngineApi.PeerNode();
