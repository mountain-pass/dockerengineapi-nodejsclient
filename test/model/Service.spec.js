  ...
  describe('(package)', function() {
    describe('Service', function() {
      ...
      it('should have the property serviceStatus (base name: "ServiceStatus")', function() {
        // TODO: update the code to test the property serviceStatus
        expect(instance).to.have.property('serviceStatus');
        // expect(instance.serviceStatus).to.be(expectedValueLiteral);
      });
