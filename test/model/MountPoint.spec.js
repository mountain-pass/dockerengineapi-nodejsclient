...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MountPoint', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.MountPoint();
      });

      it('should create an instance of MountPoint', function() {
        // TODO: update the code to test MountPoint
        expect(instance).to.be.a(DockerEngineApi.MountPoint);
      });
      ...
      it('should have the property RW (base name: "RW")', function() {
        // TODO: update the code to test the property RW
        expect(instance).to.have.property('RW');
        // expect(instance.RW).to.be(expectedValueLiteral);
      });
