  ...
  describe('(package)', function() {
    describe('Container', function() {
      ...
      it('should have the property endpointConfig (base name: "EndpointConfig")', function() {
        // TODO: update the code to test the property endpointConfig
        expect(instance).to.have.property('endpointConfig');
        // expect(instance.endpointConfig).to.be(expectedValueLiteral);
      });
