...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new DockerEngineApi.InlineObject();
      //expect(instance).to.be.a(DockerEngineApi.InlineObject);
    });

    it('should have the property name (base name: "Name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new DockerEngineApi.InlineObject();
