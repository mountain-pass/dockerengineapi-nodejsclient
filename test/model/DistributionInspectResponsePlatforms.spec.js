...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.DistributionInspectResponsePlatforms();
  });
  ...
  describe('DistributionInspectResponsePlatforms', function() {
    it('should create an instance of DistributionInspectResponsePlatforms', function() {
      // uncomment below and update the code to test DistributionInspectResponsePlatforms
      //var instane = new DockerEngineApi.DistributionInspectResponsePlatforms();
      //expect(instance).to.be.a(DockerEngineApi.DistributionInspectResponsePlatforms);
    });
    ...
    it('should have the property architecture (base name: "Architecture")', function() {
      ...
      //var instance = new DockerEngineApi.DistributionInspectResponsePlatforms();
    ...
    it('should have the property oSFeatures (base name: "OSFeatures")', function() {
