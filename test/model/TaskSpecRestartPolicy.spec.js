...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskSpecRestartPolicy', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.TaskSpecRestartPolicy();
      });

      it('should create an instance of TaskSpecRestartPolicy', function() {
        // TODO: update the code to test TaskSpecRestartPolicy
        expect(instance).to.be.a(DockerEngineApi.TaskSpecRestartPolicy);
      });
      ...
      it('should have the property maxAttempts (base name: "MaxAttempts")', function() {
        // TODO: update the code to test the property maxAttempts
        expect(instance).to.have.property('maxAttempts');
        // expect(instance.maxAttempts).to.be(expectedValueLiteral);
      });
