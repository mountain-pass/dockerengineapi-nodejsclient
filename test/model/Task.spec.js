  ...
  describe('(package)', function() {
    describe('Task', function() {
      ...
      it('should have the property slot (base name: "Slot")', function() {
        // TODO: update the code to test the property slot
        expect(instance).to.have.property('slot');
        // expect(instance.slot).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property assignedGenericResources (base name: "AssignedGenericResources")', function() {
        // TODO: update the code to test the property assignedGenericResources
        expect(instance).to.have.property('assignedGenericResources');
        // expect(instance.assignedGenericResources).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property desiredState (base name: "DesiredState")', function() {
        // TODO: update the code to test the property desiredState
        expect(instance).to.have.property('desiredState');
        // expect(instance.desiredState).to.be(expectedValueLiteral);
      });

      it('should have the property jobIteration (base name: "JobIteration")', function() {
        // TODO: update the code to test the property jobIteration
        expect(instance).to.have.property('jobIteration');
        // expect(instance.jobIteration).to.be(expectedValueLiteral);
      });
