...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.HostConfigAllOf();
  });
  ...
  describe('HostConfigAllOf', function() {
    it('should create an instance of HostConfigAllOf', function() {
      // uncomment below and update the code to test HostConfigAllOf
      //var instane = new DockerEngineApi.HostConfigAllOf();
      //expect(instance).to.be.a(DockerEngineApi.HostConfigAllOf);
    });

    it('should have the property binds (base name: "Binds")', function() {
      // uncomment below and update the code to test the property binds
      //var instance = new DockerEngineApi.HostConfigAllOf();
