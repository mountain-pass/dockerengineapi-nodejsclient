...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new DockerEngineApi.InlineObject4();
      //expect(instance).to.be.a(DockerEngineApi.InlineObject4);
    });
    ...
    it('should have the property container (base name: "Container")', function() {
      ...
      //var instance = new DockerEngineApi.InlineObject4();
