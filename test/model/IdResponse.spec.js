...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.IdResponse();
  });
  ...
  describe('IdResponse', function() {
    it('should create an instance of IdResponse', function() {
      ...
      //var instane = new DockerEngineApi.IdResponse();
      //expect(instance).to.be.a(DockerEngineApi.IdResponse);
    });

    it('should have the property id (base name: "Id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new DockerEngineApi.IdResponse();
