  ...
  describe('(package)', function() {
    describe('Volume', function() {
      ...
      it('should have the property mountpoint (base name: "Mountpoint")', function() {
        // TODO: update the code to test the property mountpoint
        expect(instance).to.have.property('mountpoint');
        // expect(instance.mountpoint).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property usageData (base name: "UsageData")', function() {
        // TODO: update the code to test the property usageData
        expect(instance).to.have.property('usageData');
        // expect(instance.usageData).to.be(expectedValueLiteral);
      });
