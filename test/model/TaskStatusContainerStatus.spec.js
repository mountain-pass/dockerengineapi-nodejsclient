...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.TaskStatusContainerStatus();
  });
  ...
  describe('TaskStatusContainerStatus', function() {
    it('should create an instance of TaskStatusContainerStatus', function() {
      // uncomment below and update the code to test TaskStatusContainerStatus
      //var instane = new DockerEngineApi.TaskStatusContainerStatus();
      //expect(instance).to.be.a(DockerEngineApi.TaskStatusContainerStatus);
    });
    ...
    it('should have the property containerID (base name: "ContainerID")', function() {
      ...
      //var instance = new DockerEngineApi.TaskStatusContainerStatus();
