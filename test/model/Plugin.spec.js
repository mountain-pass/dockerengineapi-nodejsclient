...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Plugin', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.Plugin();
      });

      it('should create an instance of Plugin', function() {
        // TODO: update the code to test Plugin
        expect(instance).to.be.a(DockerEngineApi.Plugin);
      });
      ...
      it('should have the property pluginReference (base name: "PluginReference")', function() {
        // TODO: update the code to test the property pluginReference
        expect(instance).to.have.property('pluginReference');
        // expect(instance.pluginReference).to.be(expectedValueLiteral);
      });
