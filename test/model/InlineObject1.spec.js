...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new DockerEngineApi.InlineObject1();
      //expect(instance).to.be.a(DockerEngineApi.InlineObject1);
    });

    it('should have the property detach (base name: "Detach")', function() {
      // uncomment below and update the code to test the property detach
      //var instance = new DockerEngineApi.InlineObject1();
