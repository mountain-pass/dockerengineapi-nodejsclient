...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeDescription', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.NodeDescription();
      });

      it('should create an instance of NodeDescription', function() {
        // TODO: update the code to test NodeDescription
        expect(instance).to.be.a(DockerEngineApi.NodeDescription);
      });
