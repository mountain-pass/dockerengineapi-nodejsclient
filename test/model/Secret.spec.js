...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.Secret();
  });
  ...
  describe('Secret', function() {
    it('should create an instance of Secret', function() {
      ...
      //var instane = new DockerEngineApi.Secret();
      //expect(instance).to.be.a(DockerEngineApi.Secret);
    });

    it('should have the property ID (base name: "ID")', function() {
      // uncomment below and update the code to test the property ID
      //var instance = new DockerEngineApi.Secret();
