...
(function(root, factory) {
  ...
  describe('MountBindOptions', function() {
    it('should create an instance of MountBindOptions', function() {
      ...
      //var instane = new DockerEngineApi.MountBindOptions();
    ...
    it('should have the property propagation (base name: "Propagation")', function() {
      ...
      //var instance = new DockerEngineApi.MountBindOptions();
      //expect(instance).to.be();
    });

    it('should have the property nonRecursive (base name: "NonRecursive")', function() {
      // uncomment below and update the code to test the property nonRecursive
      //var instance = new DockerEngineApi.MountBindOptions();
      //expect(instance).to.be();
    });
