...
(function(root, factory) {
  ...
  describe('TaskSpecPlacement', function() {
    it('should create an instance of TaskSpecPlacement', function() {
      // uncomment below and update the code to test TaskSpecPlacement
      //var instane = new DockerEngineApi.TaskSpecPlacement();
      //expect(instance).to.be.a(DockerEngineApi.TaskSpecPlacement);
    });

    it('should have the property constraints (base name: "Constraints")', function() {
      // uncomment below and update the code to test the property constraints
      //var instance = new DockerEngineApi.TaskSpecPlacement();
