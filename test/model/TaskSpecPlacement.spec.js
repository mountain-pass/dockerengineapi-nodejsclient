...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskSpecPlacement', function() {
      beforeEach(function() {
        instance = new DockerEngineApi.TaskSpecPlacement();
      });

      it('should create an instance of TaskSpecPlacement', function() {
        // TODO: update the code to test TaskSpecPlacement
        expect(instance).to.be.a(DockerEngineApi.TaskSpecPlacement);
      });
      ...
      it('should have the property maxReplicas (base name: "MaxReplicas")', function() {
        // TODO: update the code to test the property maxReplicas
        expect(instance).to.have.property('maxReplicas');
        // expect(instance.maxReplicas).to.be(expectedValueLiteral);
      });
