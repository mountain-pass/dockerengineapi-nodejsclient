...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.NodeStatus();
  });
  ...
  describe('NodeStatus', function() {
    it('should create an instance of NodeStatus', function() {
      ...
      //var instane = new DockerEngineApi.NodeStatus();
      //expect(instance).to.be.a(DockerEngineApi.NodeStatus);
    });

    it('should have the property state (base name: "State")', function() {
      // uncomment below and update the code to test the property state
      //var instance = new DockerEngineApi.NodeStatus();
