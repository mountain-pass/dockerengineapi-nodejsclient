  ...
  describe('(package)', function() {
    describe('Port', function() {
      ...
      it('should have the property privatePort (base name: "PrivatePort")', function() {
        // TODO: update the code to test the property privatePort
        expect(instance).to.have.property('privatePort');
        // expect(instance.privatePort).to.be(expectedValueLiteral);
      });
