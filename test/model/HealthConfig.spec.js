...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.HealthConfig();
  });
  ...
  describe('HealthConfig', function() {
    it('should create an instance of HealthConfig', function() {
      // uncomment below and update the code to test HealthConfig
      //var instane = new DockerEngineApi.HealthConfig();
      //expect(instance).to.be.a(DockerEngineApi.HealthConfig);
    });

    it('should have the property test (base name: "Test")', function() {
      // uncomment below and update the code to test the property test
      //var instance = new DockerEngineApi.HealthConfig();
