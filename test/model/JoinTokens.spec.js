...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.JoinTokens();
  });
  ...
  describe('JoinTokens', function() {
    it('should create an instance of JoinTokens', function() {
      // uncomment below and update the code to test JoinTokens
      //var instane = new DockerEngineApi.JoinTokens();
      //expect(instance).to.be.a(DockerEngineApi.JoinTokens);
    });
    ...
    it('should have the property worker (base name: "Worker")', function() {
      ...
      //var instance = new DockerEngineApi.JoinTokens();
