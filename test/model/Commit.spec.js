...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerEngineApi.Commit();
  });
  ...
  describe('Commit', function() {
    it('should create an instance of Commit', function() {
      ...
      //var instane = new DockerEngineApi.Commit();
      //expect(instance).to.be.a(DockerEngineApi.Commit);
    });

    it('should have the property ID (base name: "ID")', function() {
      // uncomment below and update the code to test the property ID
      //var instance = new DockerEngineApi.Commit();
